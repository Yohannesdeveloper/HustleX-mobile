  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute w-[500px] h-[500px] bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 blur-3xl rounded-full top-1/4 left-1/4  ${
            darkMode ? "opacity-20" : "opacity-10"
          }`}
        />
        <div
          className={`absolute w-[300px] h-[300px] bg-gradient-to-br from-purple-500 via-pink-500 to-cyan-500 blur-3xl rounded-full bottom-1/4 right-1/4  ${
