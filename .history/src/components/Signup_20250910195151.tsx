  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 transition-colors duration-300 ${
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute w-[500px] h-[500px] bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 blur-3xl rounded-full top-1/4 left-1/4 animate-pulse ${
          darkMode ? "opacity-20" : "opacity-10"
        }`} />
        <div className={`absolute w-[300px] h-[300px] bg-gradient-to-br from-purple-500 via-pink-500 to-cyan-500 blur-3xl rounded-full bottom-1/4 right-1/4 animate-pulse ${
          darkMode ? "opacity-15" : "opacity-8"
        }`} />
      </div>

      <div className={`relative z-10 backdrop-blur-xl border rounded-3xl shadow-2xl p-10 w-full max-w-md ${
        darkMode 
