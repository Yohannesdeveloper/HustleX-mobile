...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    setIsLoading(true);
    try {
      // For now, we'll implement a simple Google-like login
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors duration-300 underline disabled:opacity-50 disabled:cursor-not-allowed"
            >
