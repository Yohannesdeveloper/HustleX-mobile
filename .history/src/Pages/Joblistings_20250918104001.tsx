...
const JobListings: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row p-2 sm:p-4 lg:p-6 gap-2 sm:gap-4 max-w-7xl mx-auto">
        {/* Sidebar */}
        <motion.aside
            ...
            {loading ? (
              ...
              filteredJobs.map((job: JobType, index: number) => (
                <motion.div
                  ...
                  className={`rounded-2xl p-3 sm:p-4 md:p-6 shadow-xl transition-all duration-300 relative group border ${
                    darkMode
                ...
                >
                  ...
                  <div className="absolute top-4 sm:top-6 right-4 sm:right-6 flex gap-2">
                    {/* Delete button - only show for job owner (hirer) */}
                    {user && isAuthenticated && user._id === job.userId && (
                      <motion.button
                      ...
                      >
                        <div className="space-y-2">
                          <button
                            ...
                            className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl transition-colors text-xs sm:text-sm font-inter ${
                              darkMode
                  ...
                  {/* Job Header Section */}
                  <div className="mb-2 sm:mb-4 pr-16 sm:pr-20">
                    <div className="flex flex-col gap-2 sm:gap-3">
                      <h3
                        className={`text-xl sm:text-2xl md:text-3xl font-bold font-inter leading-tight ${
                          darkMode ? "text-white" : "text-black"
                        }`}
                      >
                      ...
                      {job.company && (
                        <p
                          className={`text-base sm:text-lg md:text-xl font-medium font-inter ${
                  ...
                  <div className="mb-2 sm:mb-4">
                    <h4
                      className={`text-base sm:text-lg font-semibold mb-2 font-inter ${
                        darkMode ? "text-white" : "text-black"
                      }`}
                    >
                      Job Description
                              ...
                              .map((paragraph, idx) => (
                                <div key={idx} className="mb-2">
                                  ...
                                  paragraph.endsWith("**") ? (
                                    <div className="mb-2">
                                      <h5
                                        className={`text-xl sm:text-2xl font-bold mb-2 pb-2 border-b-2 ${
                                          darkMode
                                    ...
                                    <div className="flex items-start gap-4 mb-1 pl-4">
                                      <span
                                        className={`text-cyan-500 mt-1 text-xl font-bold ${
                                          darkMode
                                            ? "text-cyan-400"
                                            : "text-cyan-600"
                                        }`}
                                    ...
                                    <div className="flex items-start gap-4 mb-1 pl-4">
                                      <span
                                        className={`text-green-500 mt-1 text-xl font-bold ${
                                          darkMode
                                            ? "text-green-400"
                                            : "text-green-600"
                                        }`}
                                    ...
                                    <div className="mb-2 p-3 rounded-lg bg-gradient-to-r from-transparent to-transparent hover:from-opacity-5 hover:to-opacity-5 transition-all duration-300">
                    ...
                    {(job.description || "").length > 300 && (
                      <motion.button
                        ...
                        className={`mt-6 px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium rounded-xl hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 shadow-lg text-sm sm:text-base font-inter`}
                      >
                        {expandedJobs.includes(job.id)
                          ? "Read Less"
                          : "Read More"}
                  ...
                  <div className="mb-1 sm:mb-2">
                    <h4
                      className={`text-sm sm:text-base font-semibold mb-1 font-inter ${
                        darkMode ? "text-white" : "text-black"
                      }`}
                    >
                      Job Details
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-2">
                      <div
                        className={`flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-xl border transition-all duration-300 hover:shadow-lg font-inter ${
                          darkMode
                      ...
                      >
                        ...
                        >
                          <DollarSign
                            className={`w-2 h-2 sm:w-3 sm:h-3 text-cyan-500`}
                          />
                        </div>
                        <div>
                          <p
                            className={`text-xs font-medium font-inter mb-0.5 ${
                              darkMode ? "text-white/70" : "text-gray-500"
                            }`}
                          >
                            Budget
                          ...
                          >
                            {job.budget ? `${job.budget} ETB` : "Not specified"}
                          </p>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          <Briefcase
                            className={`w-2 h-2 sm:w-3 sm:h-3 text-purple-500`}
                          />
                        </div>
                        <div>
                          <p
                      ...
                      >
                        ...
                        >
                          <MapPin
                            className={`w-2 h-2 sm:w-3 sm:h-3 text-green-500`}
                          />
                        </div>
                        <div>
                          <p
                      ...
                      >
                        ...
                        >
                          <User
                            className={`w-2 h-2 sm:w-3 sm:h-3 text-orange-500`}
                          />
                        </div>
                        <div>
                          <p
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    {job.jobLink && (
                      <motion.a
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className={`px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-500 to-green-600 font-bold rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg shadow-green-500/25 hover:shadow-green-400/40 text-sm sm:text-base font-inter flex items-center justify-center gap-2 text-white`}
                      >
          ...
          {previewJob && (
            ...
            >
              ...
              >
                ...
                <div
                  className={`mb-4 sm:mb-6 prose prose-lg max-w-none font-inter ${
                    darkMode ? "prose-invert" : ""
                  }`}
                >
                  <div
                      ...
                      .map((paragraph, idx) => (
                        <div key={idx} className="mb-1">
                          ...
                          paragraph.endsWith("**") ? (
                            <div className="mb-1">
                              <h5
                                className={`text-lg sm:text-xl font-bold mb-1 pb-2 border-b-2 ${
                                  darkMode
                                    ? "text-cyan-400 border-cyan-400/30"
                                    : "text-cyan-600 border-cyan-600/30"
                                }`}
                            ...
                            <div className="flex items-start gap-4 mb-1 pl-4">
                              <span
                                className={`text-cyan-500 mt-1 text-lg font-bold ${
                                  darkMode ? "text-cyan-400" : "text-cyan-600"
                                }`}
                              >
                                •
                            ...
                            <div className="flex items-start gap-4 mb-1 pl-4">
                              <span
                                className={`text-green-500 mt-1 text-lg font-bold ${
                            ...
                            <div className="mb-1 p-2 rounded-lg bg-gradient-to-r from-transparent to-transparent hover:from-opacity-5 hover:to-opacity-5 transition-all duration-300">
                              <p className="leading-relaxed text-justify">
                                {paragraph}
                              </p>
                            </div>
