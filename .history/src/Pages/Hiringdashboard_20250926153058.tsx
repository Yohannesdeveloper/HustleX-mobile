...
const HiringDashboard: React.FC = () => {
  ...
  const [deletingFreelancer, setDeletingFreelancer] = useState<string | null>(
    null
  );
  ...
  React.useEffect(() => {
    ...
    if (
      state?.tab &&
      ["overview", "applications", "jobs", "analytics"].includes(state.tab)
    ) {
                          ...
                          >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-start justify-between mb-2">
                                    <div>
                                      ...
                                      >
                                        {freelancer.profile?.primarySkill ||
                                          "Freelancer"}
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                <motion.button
                                  onClick={() =>
                                    handleDeleteFreelancer(freelancer._id)
                                  }
                                  disabled={
                ...
                >
                  ...
                  {!profileLoading && !companyProfile && (
                    <div className="text-center py-12">
                      ...
                      >
                        Create your company profile to start connecting with
                        freelancers
                      </p>
                      <motion.button
                        onClick={() => navigate("/company-profile")}
