                      ...
                      try {
                        ...
                        if (cvFile) {
                          try {
                            ...
                            return; // Stop further execution if CV upload fails
                          }
                        }
                        ...
                        const payload = {
                          jobId,
                          coverLetter: coverLetter || "", // Default to an empty string
                          cvUrl, // Use the uploaded CV URL or an empty string
                        };

                        console.log(
                          "Submitting application with payload:",
                          payload
                        );
