          ...
          <>
            ...
            >
              <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
                <div className="flex items-center gap-12 md:gap-20">
                  <motion.h1
                    className={`text-2xl sm:text-3xl md:text-4xl lg:text-3xl font-extrabold tracking-tight cursor-pointer transition duration-300 flex items-center`}
                    whileHover={{
                      scale: 1.1,
            ...
            <section className="min-h-screen flex flex-col items-center justify-center relative z-10 overflow-hidden">
              ...
              >
                {/* Full Screen img */}
                <img
                  src="src/Images/hero-background.png" // replace with your image path
                  alt="Hero Background"
                ...
                {/* Text Content */}
                <div className="relative z-30 px-4 sm:px-8 md:px-10 lg:px-16 xl:px-10 py-8 sm:py-12 md:py-28">
                  <motion.h2
                    className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 sm:mb-8 md:mb-10 leading-tight max-w-4xl text-left ${
                      darkMode ? "text-white" : "text-black"
                    }`}
                  ...
                  <motion.p
                    className={`text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 md:mb-12 leading-relaxed max-w-3xl text-left ${
                    ...
                    <motion.button
                      ...
                      className={`px-8 sm:px-10 md:px-12 lg:px-14 py-4 sm:py-5 md:py-6 rounded-full font-bold text-base sm:text-lg md:text-xl transition-all duration-300 shadow-2xl backdrop-blur-sm border-2 relative overflow-hidden group w-full sm:w-auto ${
                        darkMode
                          ...
                          : "border-black/50 text-black hover:bg-black/10"
                      }`}
                      whileHover={{ scale: 1.05, y: -3 }}
                      whileTap={{ scale: 0.95 }}
                    >
            ...
            >
              ...
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                >
                  <motion.button
                    onClick={() => navigate("/job-listings")}
                    className="px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 bg-transparent border-2 border-blue-600 text-blue-600 font-bold text-base sm:text-lg md:text-xl rounded-full hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-2xl backdrop-blur-sm w-full sm:w-auto"
                    whileHover={{ scale: 1.05, y: -3 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3">
