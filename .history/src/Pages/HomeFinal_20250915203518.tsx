            ...
            >
              ...
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                >
                  ...
                  <motion.button
                    onClick={() => navigate("/job-listings")}
                    className="px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 bg-transparent border-2 border-blue-600 text-blue-600 font-bold text-base sm:text-lg md:text-xl rounded-full hover:bg-red-600 hover:text-white transition-all duration-300 shadow-2xl backdrop-blur-sm w-full sm:w-auto"
                    whileHover={{ scale: 1.05, y: -3 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3">
