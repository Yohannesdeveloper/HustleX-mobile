            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div
                    className=`${darkMode ? "bg-gray-900/50 border-gray-700/50" : "bg-gray-100/50 border-gray-300/50"} border rounded-xl p-4 text-center font-inter shadow-[0_4px_6px_rgba(0,0,0,0.3)]`}
                  >
                    <Briefcase
                      className={`w-6 h-6 mx-auto mb-2 ${
                        darkMode ? "text-cyan-400" : "text-cyan-600"
