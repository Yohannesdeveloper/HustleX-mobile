  ...
  const handleSubmitApplication = async () => {
    ...
    try {
      ...
      const payload: any = {
        ...
        // Keep resumeLink for the current API signature
        resumeLink: cvUrl,
        // Provide cvUrl to match backend expectations
        cvUrl: cvUrl,
      };
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-6xl mx-auto px-6 py-12">
          ...
          {/* Inline application form disabled; using modal only */}
          {false &&
            userRole === "freelancer" &&
            !applied &&
            job.postedBy?._id !== currentUser?.id && (
