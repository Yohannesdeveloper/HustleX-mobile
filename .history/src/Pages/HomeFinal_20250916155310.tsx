            ...
            >
              <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
                <div className="flex items-center gap-12 md:gap-20">
                  <motion.h1
                    className={`text-1xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight cursor-pointer transition duration-300 flex items-center`}
                    whileHover={{
                      scale: 1.1,
                  ...
                  >
                    <span
                      ...
                      } bg-gradient-to-r from-cyan-400 via-white to-cyan-500 bg-clip-text text-transparent font-extrabold drop-shadow-[0_0_10px_rgba(0,255,255,0.7)]`}
                    >
                      Hustle
                    </span>
                    <img
                      src="/logos/Logo.png"
                      alt="logo"
                      className="mx-2 h-12 w-12 drop-shadow-[0_0_12px_rgba(0,255,255,0.6)]"
                    />
                    <span
                      className={`${
                        darkMode ? "text-white" : "text-black"
                      } bg-gradient-to-r from-cyan-900 via-white to-cyan-400 bg-clip-text text-transparent font-extrabold drop-shadow-[0_0_10px_rgba(0,255,255,0.7)]`}
                    >
                      X
                    </span>
                  </motion.h1>
