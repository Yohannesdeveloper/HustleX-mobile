                      ...
                      try {
                        ...
                        if (cvFile) {
                          try {
                            ...
                            if (uploadError.code === "ERR_NETWORK") {
                              alert(
                                "Network error: Unable to upload CV. Please check your connection."
                              );
                              ...
                              alert(
                                "Failed to upload CV: An unknown error occurred."
                              );
                            }
                            return;
                          }
                        ...
                        if (err.response) {
                          ...
                          alert(
                            "Failed to apply: No response from server. Please try again later."
                          );
                        } else {
                          console.error("Axios error details:", err.toJSON());
